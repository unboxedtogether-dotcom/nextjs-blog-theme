...
export default function Members() {
  ...
  if (error) {
    return <Layout><SEO title="My dashboard | Unboxed Together" description="Your private Unboxed Together member dashboard." path="/members" /><div className="member-page"><p className="onboarding-error" role="alert">{error}</p></div></Layout>;
  }

  if (loading || !profile || !profile.onboarding_completed) {
    return <Layout><SEO title="My dashboard | Unboxed Together" description="Your private Unboxed Together member dashboard." path="/members" /><div className="member-page"><p className="auth-loading">Loading your member space…</p></div></Layout>;
  }
