      ...
      <section className="bg-[#1e3a5f] text-white py-20 md:py-32">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#footer"
              className="btn border-2 border-white text-white hover:bg-white hover:text-[#1e3a5f] font-semibold"
            >
              Contact
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold text-[#1e3a5f] mb-4">Scan barcodes</h3>
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold text-[#1e3a5f] mb-4">See additives clearly</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold text-[#1e3a5f] mb-4">Track what works for you</h3>
              <p className="text-gray-600">
